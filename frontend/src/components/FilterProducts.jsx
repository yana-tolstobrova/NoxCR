  ...
  return (
    <div className="flex mt-8 mb-6 ml-6 md:mt-2 2xl:mt-16 justify-center">
      <Link to="/products/natural" className="mx-0 text-center sm:mx-4">
        ...
        <div className="text-center text-3xl font-semibold hover:font-bold md:text-2xl 2xl:text-5xl">Natural</div>
      </Link>
      <Link to="/products/crazy" className="mx-4 text-center">
        ...
        <div className="text-center text-3xl font-semibold hover:font-bold md:text-2xl 2xl:text-5xl">Crazy</div>
      </Link>
      <Link to="/products/sclera" className="mx-4 text-center">
        ...
        <div className="text-center text-3xl font-semibold hover:font-bold md:text-2xl 2xl:text-5xl">Sclera</div>
      </Link>
    </div>
  );
}
